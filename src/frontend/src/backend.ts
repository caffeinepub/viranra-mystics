...
export class Backend implements backendInterface {
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string | null, arg3: ServiceType, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, to_candid_opt_n12(this._uploadFile, this._downloadFile, arg2), to_candid_ServiceType_n13(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    preWeddingPhotography: null;
} | {
    aiAgent: null;
} | {
    songVideoProduction: null;
} | {
    videoThumbnail: null;
}): ServiceType {
    return "adsProduction" in value ? ServiceType.adsProduction : "videoEditing" in value ? ServiceType.videoEditing : "preWeddingPhotography" in value ? ServiceType.preWeddingPhotography : "aiAgent" in value ? ServiceType.aiAgent : "songVideoProduction" in value ? ServiceType.songVideoProduction : "videoThumbnail" in value ? ServiceType.videoThumbnail : value;
}
...
function to_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceType): {
    ...
    return value == ServiceType.adsProduction ? {
        adsProduction: null
    } : value == ServiceType.videoEditing ? {
        videoEditing: null
    } : value == ServiceType.preWeddingPhotography ? {
        preWeddingPhotography: null
    } : value == ServiceType.aiAgent ? {
        aiAgent: null
    } : value == ServiceType.songVideoProduction ? {
        songVideoProduction: null
    } : value == ServiceType.videoThumbnail ? {
        videoThumbnail: null
    } : value;
}
